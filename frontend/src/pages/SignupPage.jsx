...
export const SignupPage = () => {
  ...
  return (
    ...
    >
      {/* Animated blobs */}
      <div className="auth-blob-1 absolute -top-40 -right-40 w-[32rem] h-[32rem] rounded-full opacity-20"
        style={{ background: 'radial-gradient(circle, #7c3aed, transparent 70%)' }} />
      <div className="auth-blob-2 absolute -bottom-48 -left-48 w-[36rem] h-[36rem] rounded-full opacity-15"
        style={{ background: 'radial-gradient(circle, #06b6d4, transparent 70%)' }} />
      <div className="auth-blob-3 absolute top-1/2 right-1/3 w-72 h-72 rounded-full opacity-10"
      ...
      >
        ...
        <h2 className="text-center text-3xl font-extrabold text-white tracking-tight">
          Join <span className="gradient-text">LinkShort</span>
        </h2>
        ...
        <div className="dark-card py-8 px-6 sm:px-10 shadow-2xl">
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5">
              ...
              <Input id="password" type="password" autoComplete="new-password" required value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Minimum 6 characters" />
            </div>
